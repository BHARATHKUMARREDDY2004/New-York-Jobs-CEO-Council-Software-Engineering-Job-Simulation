...
class Invoice:
    ...
    def __init__(self,
        ...
        self.items = []
        self.comments = [] # New Feild to store comments
...
if __name__ == '__main__':
    ...
    invoice.add_comment("Additional charge for express shipping.")
    invoice.add_comment("10% student discount applied.")
    invoice_comments = invoice.get_comments()
